...
// Nested functions are able to access variables on the outter function but not on the inner function.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(lowerCaseNames){
    const newArray = lowerCaseNames.map(function(name){
  ...
  */
  ...
  function lowPopulationAnimals(lowPopulationAnimals){
    const newArray = lowPopulationAnimals.filter(function(item){
  ...
  */
  ...
  function USApop(USApop){
    const value = USApop.reduce(function(accumulator, current){
